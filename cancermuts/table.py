...
class Table:
    ...
    def to_dataframe(self, sequence, mutation_metadata=["cancer_study",
                                                        "cancer_type",
                                                        "genomic_coordinates",
                                                        "genomic_mutations",
                                                        "revel_score",
                                                        ...
                                                        "gnomad_mt_hom_allele_frequency"],
                        position_properties=['ptm_phosphorylation',
                                             'ptm_methylation',
                                             'ptm_ubiquitination',
                                             'ptm_cleavage',
                                             'ptm_nitrosylation',
